...
var defaultRenderLogoAntTitle = function defaultRenderLogoAntTitle (h, props) {
  var _props$logo = props.logo
      var logo = _props$logo === void 0 ? 'https://gw.alipayobjects.com/zos/antfincdn/PmY%24TNNDBI/logo.svg' : _props$logo
...
var SiderMenu = {
  ...
  render: function render (h) {
    var collapsible = this.collapsible
        ...
        var _this$onMenuHeaderCli = this.onMenuHeaderClick
        var onMenuHeaderClick = _this$onMenuHeaderCli === void 0 ? function () {
      return null
