...
var GlobalHeader = {
  ...
  render: function render (h) {
    ...
    var _this$$props = this.$props
        ...
        var rightContentRender = _this$$props.rightContentRender
        var headerContentRender = _this$$props.headerContentRender

    var toggle = function toggle () {
      var _this$$props2 = _this.$props
          var collapsed = _this$$props2.collapsed
          var handleCollapse = _this$$props2.handleCollapse
    ...
    var renderCollapsedButton = function renderCollapsedButton () {
      var _this$$props3 = _this.$props
          var collapsed = _this$$props3.collapsed
          var _this$$props3$collaps = _this$$props3.collapsedButtonRender
          var collapsedButtonRender = _this$$props3$collaps === void 0 ? defaultRenderCollapsedButton : _this$$props3$collaps
          var menuRender = _this$$props3.menuRender
