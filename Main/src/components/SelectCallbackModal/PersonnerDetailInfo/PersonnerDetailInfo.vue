  ...
  <a-modal
    ...
    <div class="query-table-container">
      <a-form layout="inline">
        <a-row :gutter="24">
          <a-col :md="12">
            <a-form-item :label="$t('pay.nisPersonnelDetail.field.workNo')">
              <a-input v-model="queryParam.workNo" :placeholder="$t('pay.nisPersonnelDetail.field.workNo')"/>
            </a-form-item>
          </a-col>
          <a-col :md="12">
            <a-form-item :label="$t('pay.nisPersonnelDetail.field.userName')">
              <a-input v-model="queryParam.userName" :placeholder="$t('pay.nisPersonnelDetail.field.userName')"/>
            </a-form-item>
          </a-col>
          <!--展开搜索-->
...
import { searchNisPersonnelDetail } from '@/api/pay/nisPersonnelDetail'
...
const defaultColumns = [
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.workNo',
      dataIndex: 'workNo',
      key: 'workNo',
      isSearch: true,
      width: 220,
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.userName',
      dataIndex: 'userName',
      key: 'userName',
      isSearch: true,
      width: 220,
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.sex',
      dataIndex: 'sex',
      key: 'sex',
      isSearch: true,
      width: 220,
      ...
      customRender: function (text, row) {
        return dict('pay.personnelDetail.sex', text)
      }
    },
    {
        title: 'i18n:pay.nisPersonnelDetail.field.idcard',
        dataIndex: 'idcard',
        key: 'idcard',
        isSearch: true,
        width: 220,
    ...
    {
        title: 'i18n:pay.nisPersonnelDetail.field.mobile',
        dataIndex: 'mobile',
        key: 'mobile',
        isSearch: true,
        width: 220,
    ...
    {
        title: 'i18n:pay.nisPersonnelDetail.field.corpName',
        dataIndex: 'corpName',
        key: 'corpName',
        isSearch: true,
        width: 220,
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.deptName',
      dataIndex: 'deptName',
      key: 'deptName',
      isSearch: true,
      width: 220,
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.bankAcc',
      dataIndex: 'bankAcc',
      key: 'bankAcc',
      isSearch: true,
      width: 220,
    ...
    {
      title: 'i18n:pay.nisPersonnelDetail.field.accName',
      dataIndex: 'accName',
      key: 'accName',
      isSearch: true,
      width: 220,
...
export default {
    ...
    data () {
        return {
            ...
            loadData: parameter => {
                ...
                return searchNisPersonnelDetail(requestParameters).then(res => res.data)
            },
            selectedRowKeys: [],
    ...
    async mounted () {
        ...
        // 加载指定字典组
        await dictGroup('pay.personnelDetail.sex', 'validSign')
