...
<template>
  <a-form-model
    ...
    <a-card :bordered="false">
      ...
      <a-divider style="margin-bottom: 32px"/>
      <a-descriptions :title="$t('basic.externalCorp.filed.attachmentId')">
        <a-descriptions-item :label="$t('basic.externalCorp.filed.attachmentId')">{{ formData.attachmentId }}</a-descriptions-item>
      </a-descriptions>
    </a-card>
  </a-form-model>
